...
<nav className="w3-sidebar w3-bar-block w3-card w3-animate-left w3-center" style={{display:"none"}} id="mySidebar">
  ...
  <a to="/" className="w3-bar-item w3-button">Link 1</a>
  <a to="/" className="w3-bar-item w3-button">Link 2</a>
  <a to="/" className="w3-bar-item w3-button">Link 3</a>
  <a to="/" className="w3-bar-item w3-button">Link 4</a>
</nav>
...
<header className="w3-container w3-theme w3-padding" id="myHeader">
  ...
  <h1 className="w3-xxxlarge w3-animate-bottom">BUILT WITH W3.CSS</h1>
    <div className="w3-padding-32">
      <button className="w3-btn w3-xlarge w3-dark-grey w3-hover-light-grey" onClick="document.getElementById('id01').style.display='block'" style={{fontWeight:"900"}}>LEARN W3.CSS</button>
    </div>
  </div>
</header>
...
<div id="id01" className="w3-modal">
    <div className="w3-modal-content w3-card-4 w3-animate-top">
      ...
      <div className="w3-padding">
        ...
        <p>Go to our <a className="w3-btn" to="/w3css/default.asp">W3.CSS Tutorial</a> to learn more!</p>
      </div>
...
<div className="w3-row">
  <div className="w3-col w3-container m2 w3-red"><p>Red</p></div>
  <div className="w3-col w3-container m2 w3-blue"><p>Blue</p></div>
  <div className="w3-col w3-container m2 w3-blue-grey"><p>Blue Grey</p></div>
  <div className="w3-col w3-container m2 w3-teal"><p>Teal</p></div>
  <div className="w3-col w3-container m2 w3-yellow"><p>Yellow</p></div>
  <div className="w3-col w3-container m2 w3-orange"><p>Orange</p></div>
</div>
...
<div className="w3-padding w3-white w3-display-container">
  <span onClick="this.parentElement.style.display='none'" className="w3-button w3-display-topright"><i className="fa fa-remove"></i></span>
  <h2>London</h2>
...
<div className="w3-card white">
  ...
  <div className="w3-container w3-indigo w3-large"><span className="w3-right">Next</span></div>
</div>
</div>
...
<div className="w3-card white">
  ...
  <div className="w3-container w3-theme w3-large"><span className="w3-right">Next</span></div>
</div>
</div>
</div>
...
<div className="w3-container">
  ...
  <div className="w3-center">
    <h2>Tables</h2>
    <p className="w3-large">Don't worry. W3.CSS takes care of your tables.</p>
  </div>
...
<div className="w3-light-gray">
  <div id="myBar" className="w3-center w3-padding w3-theme" style={{width:"5%"}}>5%</div>
</div><br/>
<button className="w3-btn w3-theme" onClick="move()">Click Me</button> 
</div>
<hr/>

<h2 className="w3-center">Slideshows</h2>
<div className="w3-content" style={{maxWidth:"800px",position:"relative"}}>

<img className="mySlides w3-animate-opacity" src="/w3images/snow.jpg" style={{width:"100%"}}/>
<img className="mySlides w3-animate-opacity" src="/w3images/lights.jpg" style={{width:"100%"}}/>
<img className="mySlides w3-animate-opacity" src="/w3images/mountains.jpg" style={{width:"100%"}}/>
<img className="mySlides w3-animate-opacity" src="/w3images/forest.jpg" style={{width:"100%"}}/>

<a className="w3-button w3-hover-dark-grey" style={{position:"absolute",top:"45%",left:"0"}} onClick="plusDivs(-1)">❮</a>
<a className="w3-button w3-hover-dark-grey" style={{position:"absolute",top:"45%",right:"0"}} onClick="plusDivs(+1)">❯</a>
</div>
...
<div className="w3-bar w3-theme">
  <a to="/" className="w3-bar-item w3-button w3-padding-16">Home</a>
  <a to="/" className="w3-bar-item w3-button w3-padding-16">Link 1</a>
  <div className="w3-dropdown-hover">
    ...
    <div className="w3-dropdown-content w3-card-4 w3-bar-block">
      <a to="javascript:void(0)" className="w3-bar-item w3-button">Link 1</a>
      <a to="javascript:void(0)" className="w3-bar-item w3-button">Link 2</a>
      <a to="javascript:void(0)" className="w3-bar-item w3-button">Link 3</a>
    </div>
  </div>
</div>
...
<button onClick="myAccFunc('Demo1')" className="w3-padding-16 w3-theme w3-button w3-block w3-left-align">Open Section 1</button>
<div id="Demo1" className="w3-hide">
  <div className="w3-container">
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
  </div>
</div>
<button onClick="myAccFunc('Demo2')" className="w3-padding-16 w3-theme w3-button w3-block w3-left-align">Open Section 2</button>
<div id="Demo2" className="w3-hide">
  <a to="/" className="w3-button w3-block w3-left-align">Link 1</a>
  <a to="/" className="w3-button w3-block w3-left-align">Link 2</a>
  <a to="/" className="w3-button w3-block w3-left-align">Link 3</a>
</div>
<button onClick="myAccFunc('Demo3')" className="w3-padding-16 w3-theme w3-button w3-block w3-left-align">Open Section 3</button>
...
<div className="w3-bar w3-theme">
  <button className="w3-bar-item w3-button testbtn w3-padding-16" onClick="openCity(event,'London')">London</button>
  <button className="w3-bar-item w3-button testbtn w3-padding-16" onClick="openCity(event,'Paris')">Paris</button>
  <button className="w3-bar-item w3-button testbtn w3-padding-16" onClick="openCity(event,'Tokyo')">Tokyo</button>
</div>
...
<div className="w3-center">
  ...
  <br/><br/>
  <a className="w3-button w3-circle w3-large w3-black"><i className="fa fa-plus"></i></a>
  <a className="w3-button w3-circle w3-large w3-theme"><i className="fa fa-plus"></i></a>  
  <a className="w3-button w3-circle w3-large w3-card-4"><i className="fa fa-plus"></i></a>
</div>
<br/>
<div className="w3-center">
  <div className="w3-dropdown-hover">
    <button className="w3-button w3-theme">Dropdown <i className="fa fa-caret-down"></i></button>
...
<div className="w3-center">
  ...
  <div className="w3-center w3-padding-32">
    <div className="w3-bar">
      <a to="/" className="w3-bar-item w3-button w3-hover-theme">«</a>
      <a to="/" className="w3-bar-item w3-button w3-theme w3-hover-theme">1</a>
      <a to="/" className="w3-bar-item w3-button w3-hover-theme">2</a>
      <a to="/" className="w3-bar-item w3-button w3-hover-theme">3</a>
      <a to="/" className="w3-bar-item w3-button w3-hover-theme">4</a>
      <a to="/" className="w3-bar-item w3-button w3-hover-theme">5</a>
      <a to="/" className="w3-bar-item w3-button w3-hover-theme">»</a>
    </div>
  </div>
</div>
...
<footer className="w3-container w3-theme-dark w3-padding-16">
  <h3>Footer</h3>
  <p>Powered by <a to="https://www.w3schools.com/w3css/default.asp" target="_blank">w3.css</a></p>
  <div style={{position:"relative", bottom:"55px"}} className="w3-tooltip w3-right">
    ...
    <a className="w3-text-white" to="#myHeader"><span className="w3-xlarge">
    <i className="fa fa-chevron-circle-up"></i></span></a>
  </div>
  <p>Remember to check out our <a to="w3css_references.asp" className="w3-btn w3-theme-light" target="_blank">W3.CSS Reference</a></p>
</footer>
    </>
  )
}
